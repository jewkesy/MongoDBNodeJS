...
X	The query did not utilize an index to figure out which documents match the find criteria.
X	The query used an index for the sorting phase.
	The query returned 120,477 documents
X	The query performed a full collection scan